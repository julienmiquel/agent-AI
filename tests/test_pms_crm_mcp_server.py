"""Integration tests for European Camping Group (ECG) PMS & CRM MCP App Server."""
...
def test_pms_crm_mcp_server_bundle_content():
    """Verify built HTML bundle contains ECG title, tabs, and Chart.js integration."""
    bundle_path = os.path.join(MCP_SERVER_DIR, "dist", "mcp-app.html")
    with open(bundle_path, "r", encoding="utf-8") as f:
        content = f.read()

    assert "ECG PMS & CRM Operations Control Center" in content
