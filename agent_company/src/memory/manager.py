"""Memory Manager & Context Bloat Compaction for Company Multi-Agent System.
...
_memory_executor = ThreadPoolExecutor(max_workers=4, thread_name_prefix="company_memory_worker")
