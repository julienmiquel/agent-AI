"""Firebase Cloud Firestore Data Store Interface for European Camping Group (ECG).
...
class ECGDatastore:
    ...
    def __init__(self, database_id: str = "(default)", project_id: Optional[str] = None):
        ...
        self.project_id = project_id or os.getenv("GCP_PROJECT", "ecg-genai-analytics")
        self.db = None
